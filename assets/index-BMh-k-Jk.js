(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();function L(){return`<main>
  ...
  </div>`}const l={milliseconds:1e3*60*60,seconds:1e3*60},n={profile:"/web-bee/",map:"/web-bee/map",time:"/web-bee/time"},d={profile:"Profile",map:"Map",time:"Time"},m={profile:L(),map:b(),time:y()},o={active:"active",activeLink:"activeLink",navLink:".nav-link",loader:"lds-circle"},g={hint:"Нижний Новгород",balloon:"Город на Волге"},h={paths:{[n.profile]:[m.profile],[n.map]:[m.map],[n.time]:[m.time]},titles:{[n.profile]:[d.profile],[n.map]:[d.map],[n.time]:[d.time]}};function S(t){document.querySelectorAll(o.navLink).forEach(e=>{e.classList.remove(o.active)}),document.getElementById(t).classList.add(o.active)}function T(t){const e=document.getElementById(t);sessionStorage.setItem(o.activeLink,e.href)}function k(){const t=sessionStorage.getItem(o.activeLink);t?document.querySelectorAll(o.navLink).forEach(e=>{e.href===t&&e.classList.add(o.active)}):document.getElementById("Profile").classList.add(o.active)}function I(){const t=document.getElementById("map");t&&t.classList.add(o.loader),ymaps.ready(()=>{t.classList.remove(o.loader);const e=[56.326797,44.005986],a=new ymaps.Map("map",{center:e,zoom:10}),r=new ymaps.Placemark(e,{hintContent:g.hint,balloonContent:g.balloon});a.geoObjects.add(r)})}addEventListener("DOMContentLoaded",()=>{E(),p()});document.querySelectorAll(o.navLink).forEach(t=>{t.addEventListener("click",P)});onpopstate=t=>{t.preventDefault(),p()};function E(){location.pathname==="/"&&history.replaceState({},"",n.profile)}function M(t,e){document.getElementById("app").innerHTML=t,document.title=e}function p(){const t=location.pathname,[e]=h.paths[t],a=h.titles[t];M(e,a),S(a),T(a),k(),t===n.map&&I()}function P(t){t.preventDefault();const e=t.target;history.pushState({},"",e.href),p()}let f;addEventListener("load",()=>{w()});function w(){f=Date.now(),A(),requestAnimationFrame(v)}function A(){const t=sessionStorage.getItem("timerValue");t&&(f-=parseInt(t))}function v(){const t=Date.now()-f,e=document.getElementById("count");e&&(e.textContent=C(t)),O(t),requestAnimationFrame(v)}function C(t){const e=Math.floor(t/l.milliseconds),a=Math.floor(t%l.milliseconds/l.seconds),r=Math.floor(t%l.seconds/1e3);return`${u(e)}:${u(a)}:${u(r)}`}const u=t=>t.toString().padStart(2,"0"),O=t=>{sessionStorage.setItem("timerValue",t.toString())};
